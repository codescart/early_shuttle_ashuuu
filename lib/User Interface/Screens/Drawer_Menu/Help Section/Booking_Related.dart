  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: HeadingOne(
          Title: GlobalCallClass.TripTicketTypes!.data[1].type,
          fontSize: 25,
        ),
      ),
          ...
          children: [
            ...
            Column(
              children: List.generate(
                  GlobalCallClass.TripTicketTypes!.data[1].details.length,
                      (index) {
                    final TicketType =
                    GlobalCallClass.TripTicketTypes!.data[1].details[index];
                    return Card(
